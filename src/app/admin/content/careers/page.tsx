...
import { Plus, Search, Filter, MoreVertical, Edit2, Trash2, Eye, MapPin, Briefcase } from "lucide-react";
            ...
            {jobs.length > 0 ? (
              jobs.map((job, i) => (
                <tr key={i} className="hover:bg-qbf-white/50 transition-all group">
                  ...
                  <td className="p-10 text-qbf-gray font-bold text-sm uppercase tracking-widest flex items-center gap-2 mt-4">
