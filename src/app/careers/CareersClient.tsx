...
export function CareersClient({ heroTitle, heroSubtitle, intro }: Props) {
      ...
      <div className="max-content">
        ...
        <div className="bg-qbf-black text-white p-12 md:p-20 rounded-[3rem] text-center">
          ...
          <p className="text-xl text-qbf-gray mb-12 max-w-2xl mx-auto leading-relaxed">
            We&apos;re always on the lookout for talented practitioners. Submit your CV speculatively and we&apos;ll keep you in mind for future opportunities.
          </p>
          <Link
