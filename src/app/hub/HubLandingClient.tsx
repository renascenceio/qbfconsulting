...
import { FileText, Layout, User, Briefcase } from "lucide-react";
...
export function HubLandingClient({ heroTitle, heroSubtitle, intro }: Props) {
      ...
      <div className="max-content">
        <div className="flex flex-col lg:flex-row justify-between items-center mb-32 gap-20">
          <div className="max-w-3xl text-left">
            ...
            <p className="text-2xl md:text-3xl text-qbf-gray leading-relaxed mb-12 text-pretty">
              {isRegistered
                ? "Welcome back to the Hub. You have full access to all exclusive resources."
                : heroSubtitle}
            </p>
            {intro && !isRegistered ? (
              <p className="text-base md:text-lg text-qbf-gray/90 leading-relaxed mb-12 max-w-2xl">
                {intro}
              </p>
            ) : null}
