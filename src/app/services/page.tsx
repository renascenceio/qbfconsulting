...
import { Zap, Layout, Settings, CheckCircle } from "lucide-react";
...
const services = [
  {
    ...
    description:
      "Design long-term loyalty roadmaps that balance business objectives with human behavior.",
  ...
  },
  {
    ...
    description:
      "Move from concepts to fully-operational systems. We bridge the gap between design and technology.",
  ...
  },
  {
    ...
    description:
      "Ongoing optimization and performance management to ensure your program keeps delivering value.",
        ...
        <div className="max-content">
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-7xl font-display font-black text-qbf-black mb-8 leading-[1.05] tracking-tight text-balance">
              {page.heroTitle || "Our Services."}
            </h1>
            <p className="text-2xl text-qbf-gray leading-relaxed max-w-3xl text-pretty">
              {page.heroSubtitle ||
                "End-to-end expertise for modern loyalty programs, from initial strategy to ongoing management."}
            </p>
            {page.intro && (
